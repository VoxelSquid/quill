package me.voxelsquid.quill.nms.v1_20_R4
...
class VersionBridge(private val plugin: JavaPlugin) : AbstractVersionBridge() {
    ...
    override fun addAttributeModifier(
        ...
        attributes[attribute]?.let { meta.addAttributeModifier(it, AttributeModifier(UUID.randomUUID(), "$slot", amount, operation, slot)) }
    }
